                    ...
                    <div className="border-t border-gray-100 pt-3">
                      ...
                      <div className="mt-3">
                        <input
                          ...
                          accept="image/*"
                          className="hidden"
                          id={`upload-${treatment.id}`}
                        />
                        <label
                          htmlFor={`upload-${treatment.id}`}
                          className="flex items-center text-sm text-rose-600 hover:text-rose-700 font-medium cursor-pointer"
                        >
